...
export function AdminDashboardPageContent() {
  ...
  const dateQuery = useAppSelector(selectDashboardDateQuery);
    ...
    <section className="mx-auto max-w-6xl space-y-8 p-4 sm:p-6 lg:p-8">
      ...
      {statisticsStatus === "failed" ? (
        <div className="space-y-3">
          <div className={adminAlertErrorClass}>
          ...
          {ANALYTICS_TABS.map((tab) => {
            ...
            return (
              <button
                ...
                className={cn(adminSegmentTabClass(isActive), "inline-flex items-center gap-2")}
              >
