...
export const orderShippedEmailPreview: EmailPreview = {
  id: "order-shipped",
  label: "Order Shipped",
  subject: "Your Deepsky Nation order #DSN-10042 has shipped",
  html: `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="utf-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1" />
  <title>Order shipped — #DSN-10042</title>
</head>
          ...
          <tr>
            <td style="padding:32px 28px;text-align:center;">
              ...
              <p style="margin:0;font-size:14px;line-height:1.6;color:rgba(0,0,0,0.6);">
                Hi Alex, order <strong>#DSN-10042</strong> was shipped on Jul 10, 2026 at 03:15 PM. Your items are on their way.
              </p>
            </td>
          </tr>
          <tr>
