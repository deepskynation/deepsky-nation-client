/** Reference mock — inline HTML. Sync with deepsky-nation-server/emails/new-release-digest.html */
...
export const newReleaseDigestEmailPreview: EmailPreview = {
  ...
  label: "New Release Digest",
  subject: "New arrivals at Deepsky Nation",
  html: `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="utf-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1" />
  <title>New arrivals at Deepsky Nation</title>
</head>
<body style="margin:0;padding:0;background-color:#f9fafb;font-family:Calibre,system-ui,sans-serif;">
  <div style="display:none;max-height:0;overflow:hidden;mso-hide:all;">
    Fresh drops just landed — shop now
  </div>
